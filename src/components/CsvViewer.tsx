        ...
        >
          <label className="flex flex-col items-center justify-center w-full p-12 border-2 border-dashed border-white/20 rounded-lg cursor-pointer hover:border-white/40 transition-all group">
            <div className="flex items-center justify-center mb-4">
              ...
              <FileText className="w-8 h-8 ml-2 text-emerald-400" />
            </div>
          ...
          <div className="mt-8 space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <select
                ...
                className="bg-white/5 border border-white/20 rounded-lg px-4 py-2 focus:outline-none focus:border-emerald-500 transition-all"
              >
